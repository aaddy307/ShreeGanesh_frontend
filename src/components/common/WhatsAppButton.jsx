...
const WhatsAppButton = ({ message = '', size = 'md' }) => {
  const sizeClasses = {
  ...
  return (
    <a
      ...
      className={`inline-flex items-center gap-2 bg-[#25D366] text-white font-semibold rounded-lg hover:bg-[#20ba5a] transition-all shadow-md active:scale-95 ${sizeClasses[size]}`}
    >
